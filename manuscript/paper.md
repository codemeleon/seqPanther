...
Availability: `SeqPanther` is available at [https://github.com/codemeleon/seqPanther](https://github.com/codemeleon/seqPanther), along with the necessary documentation for installation and usage.
...
6 & AC\textcolor{red}{T TC}A & ACA & Deletion of triplet bases in two codons & TS-to-T & Substitution of two amino acids with one \\ \hline
