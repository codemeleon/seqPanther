...
- **cc2ns**: accepts as input the changes file generated by **cc2ns** and modifies the consensus sequences accordingly i.e. adds or changes the mutations as specified in the file. <!--Providing options to users to select changes of their interests-->
...
For bug reporting, support or to propose a new feature, please open an issue.
